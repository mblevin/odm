...
class Event < ActiveRecord::Base
  ...
  def set_center
    ...
    current_map.update_attributes(:geo_center_latitude => geo_center[0]) if !geo_center[0].nan?
    current_map.update_attributes(:geo_center_longitude => geo_center[1]) if !geo_center[1].nan?
